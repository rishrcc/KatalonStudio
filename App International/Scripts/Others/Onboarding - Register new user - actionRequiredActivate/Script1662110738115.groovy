...
println "Sca token is: " + sca_token_trim
...
ActiveUser.append("User profile status after OT validation:" + userStatusResBefSCT + "\n")
ActiveUser.append("User profile status after callback 32:" + userStatusResAfterSCT + "\n")
